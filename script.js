...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projects = [
    ...
    { cat: 'reels', label: 'Reels', title: 'Behind the Beat — Artist Reel', desc: 'A day-in-the-life reel for a recording artist, cut to the drop for maximum replay value.', grad: 'linear-gradient(135deg,#1c5e3a,#0f2216)', youtube: 'tCwwrIIyo8M' },
